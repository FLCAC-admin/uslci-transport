...
# Check that all of the data has been appropriatly cleaned and sorted
if total > 99.9:
    print('QC check passed. Cleaning up variables.')
    ...
    sys.exit('Terminating script. QC check failed.')
